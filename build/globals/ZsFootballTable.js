...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'id', opt_data.id, 'class', 'zsfootball-table');
    ...
    function $renderTable_(opt_data, opt_ignored, opt_ijData) {
      ie_open('table', null, null, 'class', 'table' + (opt_data.elementClasses ? ' ' + opt_data.elementClasses : ''));
      ie_open('thead');
      ie_open('tr');
      ...
      for (var keyIndex30 = 0; keyIndex30 < keyListLen30; keyIndex30++) {
        ...
        if (opt_data.columnConfig[keyData30]) {
          ie_open('th', null, null, 'class', 'col-' + opt_data.columnClasses[columnIndex__soy22]);
          ie_open('span', null, null, 'class', 'table-column');
    ...
    function $renderRow_(opt_data, opt_ignored, opt_ijData) {
      ie_open('tr', null, null, 'class', 'row-' + opt_data.rowIndex);
      ...
      for (var keyIndex55 = 0; keyIndex55 < keyListLen55; keyIndex55++) {
        ...
        if (opt_data.columnConfig[keyData55]) {
          ie_open('td', null, null, 'class', opt_data.columnClasses[keyIndex55]);
    ...
    function $renderRange_(opt_data, opt_ignored, opt_ijData) {
      ie_open('input', null, null, 'data-onchange', 'changeTableContents', 'id', 'round', 'min', '1', 'max', opt_data.maxValue, 'type', 'range', 'value', opt_data.value);
      ie_close('input');
    }
  ...
  var ZsFootballTable = function (_Component) {
    babelHelpers.inherits(ZsFootballTable, _Component);

    function ZsFootballTable() {
      babelHelpers.classCallCheck(this, ZsFootballTable);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }

    return ZsFootballTable;
  }(Component);

  Soy.register(ZsFootballTable, templates);
  this.metalNamed.ZsFootballTable = this.metalNamed.ZsFootballTable || {};
  this.metalNamed.ZsFootballTable.ZsFootballTable = ZsFootballTable;
  this.metalNamed.ZsFootballTable.templates = templates;
  this.metal.ZsFootballTable = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	...
	var ZsFootballTable = function (_Component) {
		...
		ZsFootballTable.prototype.created = function created() {
			if (!this.rounds.length && this.matches.length) {
				...
				Ajax.request(this.url.toString(), 'get').then(function (xhrResponse) {
   ...
   */
		...
		ZsFootballTable.prototype.addPoints_ = function addPoints_(club, goalFor, goalAgainst) {
   ...
   */
		...
		ZsFootballTable.prototype.calculateRowClass_ = function calculateRowClass_(club) {
			var className = '';
   ...
   */
		...
		ZsFootballTable.prototype.changeTableContents = function changeTableContents(event) {
			var rangeElement = event.delegateTarget;
   ...
   */
		...
		ZsFootballTable.prototype.cloneClubRound_ = function cloneClubRound_(clubRound) {
			var object = {};

			Object.keys(clubRound).forEach(function (key) {
				var object2 = {};
				var club = clubRound[key];
   ...
   */
		...
		ZsFootballTable.prototype.makeClubRounds_ = function makeClubRounds_(matches) {
			var clubRounds = {};
   ...
   */
		...
		ZsFootballTable.prototype.processMatches_ = function processMatches_() {
			var clubRounds = this.makeClubRounds_(this.matches),
			    rounds = [],
			    clubPositions = {};

			Object.keys(clubRounds).forEach(function (key) {
				var clubRound = clubRounds[key];
				var round = [];
				...
				round.sort(function (club1, club2) {
					...
					if (pointsDifference !== 0) {
						...
						var club1GoalDifference = club1.goalFor - club1.goalAgainst;
						var club2GoalDifference = club2.goalFor - club2.goalAgainst;
   ...
   */
		...
		ZsFootballTable.prototype.setUrl_ = function setUrl_(value) {
			var uri;
  ...
  */
   ...
   */
	...
	this.metal.ZsFootballTable = ZsFootballTable;
}).call(this);
}).call(this);
//# sourceMappingURL=ZsFootballTable.js.map
